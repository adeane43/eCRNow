...
public class Dstu2CdaFhirUtilitiesTest extends BaseGenerator {
  ...
  public void testGetIdentifierForType_notFound() {
    ...
    BoundCodeableConceptDt<IdentifierTypeCodesEnum> enumBoundCodeableConceptDt =
  ...
  public void testIdentifierFound() {
    ...
    IdentifierDt result =
        Dstu2CdaFhirUtilities.getIdentifierForSystem(ids, "http://example.com/system1");
  ...
  public void testIdentifierNotFound() {
    ...
    IdentifierDt result =
        Dstu2CdaFhirUtilities.getIdentifierForSystem(ids, "http://example.com/system3");
  ...
  public void testNullList() {
    IdentifierDt result =
        Dstu2CdaFhirUtilities.getIdentifierForSystem(null, "http://example.com/system1");
  ...
  public void testNullSystem() {
    List<IdentifierDt> ids = Arrays.asList(new IdentifierDt("http://example.com/system1", "12345"));
  ...
  public void testGetCodeableConceptExtension_WhenExtensionExists() {
    ...
    expectedConcept
        .addCoding(new CodingDt("http://snomed.info/sct", "44054006"))
        .setText("Diabetes Type 2");

    ExtensionDt ext1 = new ExtensionDt().setUrl("http://hosp.com/patient-blood-type");
    ExtensionDt ext2 =
        new ExtensionDt().setUrl("http://hosp.com/patient-condition").setValue(expectedConcept);
    ...
    CodeableConceptDt actualConcept =
        Dstu2CdaFhirUtilities.getCodeableConceptExtension(
            extensions, "http://hosp.com/patient-condition");
  ...
  public void testGetCodeableConceptExtension_WhenExtensionDoesNotExist() {
    ...
    ExtensionDt ext1 =
        new ExtensionDt().setUrl("http://hosp.com/patient-blood-type").setValue(conditionConcept);
    ...
    CodeableConceptDt actualConcept =
        Dstu2CdaFhirUtilities.getCodeableConceptExtension(
            extensions, "http://hosp.com/patient-medication");
  ...
  public void testGetCodeableConceptExtension_WithNullUrlInExtension() {
    ...
    ExtensionDt ext2 =
        new ExtensionDt()
            .setUrl("http://hosp.com/patient-diagnosis")
            .setValue(
                new CodeableConceptDt()
                    .addCoding(new CodingDt("http://snomed.info/sct", "123456"))
                    .setText("Asthma"));
    ...
    CodeableConceptDt actualConcept =
        Dstu2CdaFhirUtilities.getCodeableConceptExtension(
            extensions, "http://hosp.com/patient-diagnosis");
  ...
  public void testGetMatchingCodeFromCodingForCodeSystem_Dstu2() {
    ...
    String result =
        Dstu2CdaFhirUtilities.getMatchingCodeFromCodingForCodeSystem(matchedCodes, cds, csUrl);
  ...
  public void testGetCodingExtension_TopLevelMatch() {
    ...
    CodingDt result =
        Dstu2CdaFhirUtilities.getCodingExtension(
            exts, "http://hosp.com/ext", "http://hosp.com/subext");
  ...
  public void testGetCodingExtension_NullOrEmptyList() {
    assertNull(
        Dstu2CdaFhirUtilities.getCodingExtension(
            null, "http://hosp.com/ext", "http://hosp.com/subext"));
    assertNull(
        Dstu2CdaFhirUtilities.getCodingExtension(
            new ArrayList<>(), "http://hosp.com/ext", "http://hosp.com/subext"));
  }
  ...
  public void testGetXmlForPeriodDt() {
    ...
    String expected =
        "<effectiveTime> <low value=\"19700127212023+0000\"/> <high value=\"19700130045343+0000\"/> </effectiveTime>";
    String actual = Dstu2CdaFhirUtilities.getXmlForType(period, "effectiveTime", true);
    assertEquals(
        StringUtils.normalizeSpace(expected).trim(), StringUtils.normalizeSpace(actual).trim());
  }
  ...
  public void testGetPeriodXmlForValueElement_WithStartAndEndDates() {
    ...
    String expectedXml =
        "<effectiveTime xsi:type=\"IVL_TS\"><low value=\"20230101000000+0000\"/>\n"
  ...
  public void testGetEncounterClassCodeXml_Ambulatory() {
    BoundCodeDt<EncounterClassEnum> encClass =
        new BoundCodeDt<>(EncounterClassEnum.VALUESET_BINDER, EncounterClassEnum.AMBULATORY);
    String expectedXml =
  ...
  public void testGetEncounterClassCodeXml_Outpatient() {
    BoundCodeDt<EncounterClassEnum> encClass =
        new BoundCodeDt<>(EncounterClassEnum.VALUESET_BINDER, EncounterClassEnum.OUTPATIENT);
  ...
  public void testGetEncounterClassCodeXml_Inpatient() {
    BoundCodeDt<EncounterClassEnum> encClass =
        new BoundCodeDt<>(EncounterClassEnum.VALUESET_BINDER, EncounterClassEnum.INPATIENT);
    String expectedXml =
        CdaGeneratorUtils.getXmlForCD(
            CdaGeneratorConstants.CODE_EL_NAME,
  ...
  public void testGetEncounterClassCodeXml_Emergency() {
    BoundCodeDt<EncounterClassEnum> encClass =
        new BoundCodeDt<>(EncounterClassEnum.VALUESET_BINDER, EncounterClassEnum.EMERGENCY);
    String expectedXml =
        CdaGeneratorUtils.getXmlForCD(
            CdaGeneratorConstants.CODE_EL_NAME,
  ...
  public void testGetCodingDisplayForCodeSystem_WithDisplay() {
    ...
    List<CodingDt> codings =
        Arrays.asList(new CodingDt("http://loinc.org", "1234").setDisplay("Test Loinc"));
    Pair<String, Boolean> result =
        Dstu2CdaFhirUtilities.getCodingDisplayForCodeSystem(codings, "http://loinc.org", false);
  ...
  public void testGetCodingDisplayForCodeSystem_WithNoDisplay() {
    ...
    List<CodingDt> codingsNoDisplay =
        Arrays.asList(
            new CodingDt("http://loinc.org", "1234"), // No display
            new CodingDt("http://snomed.info", "5678"));
    Pair<String, Boolean> result =
        Dstu2CdaFhirUtilities.getCodingDisplayForCodeSystem(
            codingsNoDisplay, "http://loinc.org", false);
  ...
  public void testGetCodingDisplayForCodeSystem_WithCsOptionalTrue() {
    ...
    Pair<String, Boolean> result =
        Dstu2CdaFhirUtilities.getCodingDisplayForCodeSystem(
            codingsNoDisplay, "http://loinc.org", true);
  ...
  public void testGetCodingDisplayForCodeSystem_WithEmptyCodeSystemUrl() {
    List<CodingDt> codings =
        Arrays.asList(new CodingDt("http://loinc.org", "1234").setDisplay("Test Loinc"));
    Pair<String, Boolean> result =
        Dstu2CdaFhirUtilities.getCodingDisplayForCodeSystem(codings, "", true);
  ...
  public void testGetCodingDisplayForCodeSystem_WithNoMatchingSystem() {
    List<CodingDt> codings =
        Arrays.asList(new CodingDt("http://loinc.org", "1234").setDisplay("Test Loinc"));
    Pair<String, Boolean> result =
        Dstu2CdaFhirUtilities.getCodingDisplayForCodeSystem(codings, "http://example.com", false);
    assertEquals("", result.getValue0()); // No display text found
  ...
  public void testGetCodingDisplayForCodeSystem_WithEmptyList() {
    ...
    Pair<String, Boolean> result =
        Dstu2CdaFhirUtilities.getCodingDisplayForCodeSystem(
            Collections.emptyList(), "http://loinc.org", false);
  ...
  public void testGetCodingDisplayForCodeSystem_WithNullList() {
    ...
    Pair<String, Boolean> result =
        Dstu2CdaFhirUtilities.getCodingDisplayForCodeSystem(null, "http://loinc.org", false);
    assertEquals("", result.getValue0()); // No codings to process
    assertFalse(result.getValue1()); // Did not find the system
  }
  ...
  public void testGetIDataTypeXml_CodingDtWithDisplay() {
    ...
    String expected =
        "<value xsi:type=\"CD\" code=\"1234\" codeSystem=\"2.16.840.1.113883.6.1\" codeSystemName=\"LOINC\" displayName=\"Test Loinc\"></value>";
  ...
  public void testGetIDataTypeXml_CodeableConceptDt() {
    ...
    String expected =
        "<value xsi:type=\"CD\" code=\"5678\" codeSystem=\"\" codeSystemName=\"\" displayName=\"Test Snomed\"></value>";
  ...
  public void testGetIDataTypeXml_Null() {
    ...
    assertXmlEquals(
        ...
        result); // Expecting an empty string or empty XML tag
  }
  ...
  public void testGetIDataTypeXml_CodingDtWithoutDisplay() {
    ...
    String expected =
        "<value xsi:type=\"CD\" code=\"1234\" codeSystem=\"2.16.840.1.113883.6.1\" codeSystemName=\"LOINC\"></value>";
  ...
  public void testGetIDataTypeXml_ValFlagFalse() {
    ...
    String expected =
        "<code code=\"1234\" codeSystem=\"2.16.840.1.113883.6.1\" codeSystemName=\"LOINC\" displayName=\"Test Loinc\"></code>";
  ...
  public void testGetCodingForMultipleValidCodeSystems() {
    ...
    CodingDt coding4 =
        new CodingDt("http://example.com", "8888").setDisplay("Another Invalid Code");
  ...
  public void getCodeableConceptDisplayForCodeSystem() {
    ...
    codings.add(
        new CodingDt().setSystem("http://fhir.org").setCode("abcd").setDisplay("Test Fhir"));
  ...
  public void getStringForType_Test_Display() {
    ...
    String actual = Dstu2CdaFhirUtilities.getStringForType(codingDt);
  ...
  public void getStringForType_Test_CodeableConcept() {
    ...
    CodeableConceptDt codeableConceptDt = new CodeableConceptDt();
    codeableConceptDt.setText("MockText");
    String actual = Dstu2CdaFhirUtilities.getStringForType(codeableConceptDt);
  ...
  public void testGetCodeableConceptXml_withValidCodes() {
    ...
    String excepted =
        "<value xsi:type=\"CD\" code=\"12345\" codeSystem=\"2.16.840.1.113883.6.1\" codeSystemName=\"LOINC\"></value>\n";
  ...
  public void testGetCodingXml_withValidCodingList() {
    ...
    String excepted =
        "<code code=\"12345\" codeSystem=\"2.16.840.1.113883.6.1\" codeSystemName=\"LOINC\" displayName=\"Test Code Display\"></code>";
  ...
  public void testGetCodingXmlForValue_withValidCodingList() {
    ...
    String excepted =
        "<value xsi:type=\"CD\" code=\"12345\" codeSystem=\"2.16.840.1.113883.6.1\" codeSystemName=\"LOINC\" displayName=\"Test Code Display\"></value>";
  ...
  public void testGetCodeableConceptXml_withEmptyCodes() {
    ...
    assertNotNull(result);
    assertTrue(
        result.contains(CdaGeneratorUtils.getXmlForNullCD(CD_NAME, CdaGeneratorConstants.NF_NI)));
  }
  ...
  @Test
  public void test_getXmlForTypeForCodeSystem_dtNull() {
    String result =
        Dstu2CdaFhirUtilities.getXmlForTypeForCodeSystem(
            null, "someElement", false, "someCodeSystem", false);
    String expected = CdaGeneratorUtils.getXmlForNullCD("someElement", CdaGeneratorConstants.NF_NI);
    assertEquals(expected, result);
  }

  @Test
  public void test_getXmlForTypeForCodeSystem_CodingDt_valFlagFalse() {

    CodingDt codingDt = new CodingDt();
    codingDt.setCode("code123");
    codingDt.setSystem("http://example.org/fhir/codesystem");
    List<CodingDt> codingDtList = new ArrayList<>();
    codingDtList.add(codingDt);
    String result =
        Dstu2CdaFhirUtilities.getXmlForTypeForCodeSystem(
            codingDt, "codingElement", false, "http://example.org/fhir/codesystem", false);
    String expected =
        Dstu2CdaFhirUtilities.getCodingXmlForCodeSystem(
            codingDtList, "codingElement", "http://example.org/fhir/codesystem", false, "");
    assertEquals(expected, result);
  }

  @Test
  public void test_getXmlForTypeForCodeSystem_CodingDt_valFlagTrue() {
    ...
    String result =
        Dstu2CdaFhirUtilities.getXmlForTypeForCodeSystem(
            codingDt, "codingElement", true, "http://example.org/fhir/codesystem", false);

    String expected =
        Dstu2CdaFhirUtilities.getCodingXmlForValueForCodeSystem(
            codingDtList, "codingElement", "http://example.org/fhir/codesystem", false);
  ...
  @Test
  public void test_getXmlForTypeForCodeSystem_CodeableConceptDt_valFlagFalse() {

    CodeableConceptDt codeableConceptDt = new CodeableConceptDt();
    CodingDt codingDt = new CodingDt("code123", "http://example.org/fhir/codesystem");
    ...
    String result =
        Dstu2CdaFhirUtilities.getXmlForTypeForCodeSystem(
            codeableConceptDt, "codingElement", false, "http://example.org/fhir/codesystem", false);
  ...
  @Test
  public void test_getXmlForTypeForCodeSystem_CodeableConceptDt_valFlagTrue() {
    ...
    String result =
        Dstu2CdaFhirUtilities.getXmlForTypeForCodeSystem(
            codeableConceptDt, "codingElement", true, "http://example.org/fhir/codesystem", false);
  ...
  @Test
  public void
      test_getCombinationStringForCodeSystem_CodeableConceptDt_with_CodingDt_CodeableConceptDt() {

    CodeableConceptDt code = new CodeableConceptDt();
    CodingDt coding = new CodingDt();
    coding.setCode("code12");
    coding.setSystem("http://example.org/fhir/codesystem");
    coding.setDisplay("code123");
    code.addCoding(coding);
    String expected = "code123-code123";
    String result =
        Dstu2CdaFhirUtilities.getCombinationStringForCodeSystem(
            code, code, "http://example.org/fhir/codesystem", false);
    assertEquals(expected, result);
  }

  @Test
  public void test_getCombinationStringForCodeSystem_CodeableConcept_and_StringDt_value() {

    CodeableConceptDt codeableConcept = new CodeableConceptDt();
    CodingDt coding = new CodingDt();
    coding.setCode("code1");
    coding.setSystem("http://example.org/fhir/codesystem");
    coding.setDisplay("1234");
    codeableConcept.addCoding(coding);

    StringDt stringValue = new StringDt("value123");
    String expected = "1234-";
    String result =
        Dstu2CdaFhirUtilities.getCombinationStringForCodeSystem(
            codeableConcept, stringValue, "http://example.org/fhir/codesystem", false);
    assertEquals(expected, result);
  }

  @Test
  public void test_getCombinationStringForCodeSystem_Null_code_and_CodingDt_value() {
    CodeableConceptDt codeableConceptDt = new CodeableConceptDt();

    CodingDt codingValue = new CodingDt();
    codingValue.setCode("code1");
    codingValue.setSystem("http://example.org/fhir/codesystem");
    codingValue.setDisplay("value123");
    codeableConceptDt.addCoding(codingValue);

    String result =
        Dstu2CdaFhirUtilities.getCombinationStringForCodeSystem(
            codeableConceptDt, codingValue, "http://example.org/fhir/codesystem", false);
    String expected = "value123-value123";
    assertEquals(expected, result);
  }

  @Test
  public void test_getCodeableConceptXmlForCodeSystem_with_valid_codes() {

    CodeableConceptDt codeableConcept = new CodeableConceptDt();
    CodingDt coding = new CodingDt();
    coding.setCode("code123");
    coding.setSystem("http://loinc.org");
    coding.setDisplay("Code 123");
    codeableConcept.addCoding(coding);
    ...
    String expectedXml =
        "<code code=\"code123\" codeSystem=\"2.16.840.1.113883.6.1\" codeSystemName=\"LOINC\" displayName=\"Code 123\"></code>\n";

    String result =
        Dstu2CdaFhirUtilities.getCodeableConceptXmlForCodeSystem(
            cds, "code", false, "http://loinc.org", false);

    assertEquals(expectedXml, result);
  }

  @Test
  public void test_getCodeableConceptXmlForCodeSystem_with_true() {
    ...
    String expectedXml =
        "<value xsi:type=\"CD\" code=\"code123\""
            + " codeSystem=\"2.16.840.1.113883.6.1\" codeSystemName=\"LOINC\" "
            + "displayName=\"Code 123\"></value>\n";

    String result =
        Dstu2CdaFhirUtilities.getCodeableConceptXmlForCodeSystem(
            cds, "code", true, "http://loinc.org", false);

    assertEquals(expectedXml, result);
  }

  @Test
  public void test_isCodePresentInCoding_with_empty_list() {

    List<CodingDt> cds = new ArrayList<>();
    Boolean result = Dstu2CdaFhirUtilities.isCodePresentInCoding("code123", cds);
    assertFalse(result);
  }

  @Test
  public void test_isCodePresentInCoding_with_matching_code() {
    CodingDt coding = new CodingDt();
    coding.setCode("code123");
    List<CodingDt> cds = new ArrayList<>();
    cds.add(coding);
  ...
  @Test
  public void test_isCodePresentInCoding_with_no_matching_code() {

    CodingDt coding = new CodingDt();
    coding.setCode("code456");
    List<CodingDt> cds = new ArrayList<>();
    cds.add(coding);
    Boolean result = Dstu2CdaFhirUtilities.isCodePresentInCoding("code123", cds);
    assertFalse(result);
  ...
  @Test
  public void getNameXml_Test_success() {

    List<HumanNameDt> humanNames = new ArrayList<>();
    HumanNameDt humanName = new HumanNameDt();
    List<StringDt> theGiven = new ArrayList<>();
    theGiven.add(new StringDt("john"));
    theGiven.add(new StringDt("mark"));

    humanName.setUse(OFFICIAL);
    List<StringDt> family = new ArrayList<>();
    family.add(new StringDt("khardan"));
    family.add(new StringDt("ivan"));
    humanName.setFamily(family);
    humanName.setGiven(theGiven);

    humanNames.add(humanName);

    String nameXml = Dstu2CdaFhirUtilities.getNameXml(humanNames);
    String expected =
        "<given>john</given>\n" + "<given>john</given>\n" + "<family>khardan</family>";
    assertEquals(expected.trim(), nameXml.trim());
  }

  @Test
  public void getNameXml_HumanNameDt_Test_null() {

    String nameXml = Dstu2CdaFhirUtilities.getNameXml((List<HumanNameDt>) null);
    String expected = "<given nullFlavor=\"NI\"/>\n" + "<family nullFlavor=\"NI\"/>\n";
    assertEquals(expected, nameXml);
  }

  @Test
  public void getNameXml_Test_familyNameEmpty() {
    ...
    List<StringDt> family = new ArrayList<>();
    humanName.setFamily(family); // No family name
    humanName.setGiven(theGiven);
    ...
    String expected = "<given>john</given>\n" + "<family nullFlavor=\"NI\"/>\n";

    assertEquals(expected.trim(), nameXml.trim());
  }

  @Test
  public void getNameXml_Test_noGivenName() {
    List<HumanNameDt> humanNames = new ArrayList<>();
    HumanNameDt humanName = new HumanNameDt();
    List<StringDt> theGiven = new ArrayList<>();
    humanName.setUse(OFFICIAL);
    List<StringDt> family = new ArrayList<>();
    family.add(new StringDt("doe"));
    humanName.setFamily(family);
    humanName.setGiven(theGiven);
  ...
  @Test
  public void getNameXml_Test_HumanDt_success() {
    ...
    String nameXml = Dstu2CdaFhirUtilities.getNameXml(humanName);
    String expected = "<given>John</given>\n" + "<family>Doe</family>";
    assertEquals(expected.trim(), nameXml.trim());
  }

  @Test
  public void getNameXml_Test_givenNameEmpty() {
  ...
  @Test
  public void getNameXml_Test_noGivenAndFamilyName() {
    HumanNameDt humanName = new HumanNameDt();
  ...
  @Test
  public void getStringForIDataType_CodingDt_ValidDisplay() {

    CodingDt codingDt = new CodingDt();
    codingDt.setDisplay("Test Display");
    String result = Dstu2CdaFhirUtilities.getStringForIDataType(codingDt);
    assertEquals("Test Display", result);
  }

  @Test
  public void getStringForIDataType_CodingDt_ValidCode() {
    CodingDt codingDt = new CodingDt();
    codingDt.setSystem("http://example.com");
    codingDt.setCode("12345");
    String result = Dstu2CdaFhirUtilities.getStringForIDataType(codingDt);
    assertEquals("http://example.com|12345", result);
  }

  @Test
  public void getStringForIDataType_CodeableConceptDt_ValidText() {
    CodeableConceptDt codeableConceptDt = new CodeableConceptDt();
    codeableConceptDt.setText("Valid Text");
    String result = Dstu2CdaFhirUtilities.getStringForIDataType(codeableConceptDt);
    assertEquals("Valid Text", result);
  }

  @Test
  public void getStringForIDataType_CodeableConceptDt_ValidCoding() {
    CodeableConceptDt codeableConceptDt = new CodeableConceptDt();
    CodingDt coding = new CodingDt();
    coding.setDisplay("Display Text");
    codeableConceptDt.addCoding(coding);
  ...
  @Test
  public void getStringForIDataType_CodeableConceptDt_ValidCodingWithCode() {
    CodeableConceptDt codeableConceptDt = new CodeableConceptDt();
    CodingDt coding = new CodingDt();
  ...
  @Test
  public void getStringForIDataType_QuantityDt_Valid() {
    QuantityDt quantityDt = new QuantityDt();
    quantityDt.setValue(100.0);
    quantityDt.setSystem("http://unitsofmeasure.org");
    quantityDt.setUnit("ml");
    String result = Dstu2CdaFhirUtilities.getStringForIDataType(quantityDt);
    assertEquals("100.0|http://unitsofmeasure.org|ml", result);
  }

  @Test
  public void getStringForIDataType_NullInput() {
    String result = Dstu2CdaFhirUtilities.getStringForIDataType(null);
    assertEquals(CdaGeneratorConstants.UNKNOWN_VALUE, result);
  }

  @Test
  public void getStringForIDataType_CodeDt_Valid() {
    CodeDt codeDt = new CodeDt("test-code");
    String result = Dstu2CdaFhirUtilities.getStringForIDataType(codeDt);
    assertEquals("test-code", result);
  }

  @Test
  public void getStringForIDataType_DateTimeDt() {

    String dateTimeValue = "2025-02-21T06:27:37+00:00";
    DateTimeDt dateTime = new DateTimeDt(dateTimeValue);
    String result = Dstu2CdaFhirUtilities.getStringForIDataType(dateTime);
    assertNotNull(result);
    assertEquals(dateTimeValue, result);
  }

  @Test
  public void testGetStringForIDataType_DateDt() {
    DateDt date = new DateDt("2025-02-21");
    String result = Dstu2CdaFhirUtilities.getStringForIDataType(date);
    String expected = "2025-02-21";
    assertNotNull(result);
    assertEquals(expected, result);
  }

  @Test
  public void getStringForIDataType_period() {
    PeriodDt period =
        new PeriodDt()
            .setStart(new DateTimeDt("2023-05-01T00:00:00Z"))
            .setEnd(new DateTimeDt("2023-05-31T23:59:59Z"));
    String result = Dstu2CdaFhirUtilities.getStringForIDataType(period);
    assertEquals("Mon May 01 00:00:00 UTC 2023|Wed May 31 23:59:59 UTC 2023", result);
  }

  @Test
  public void getStringForIDataType_period_start() {
    PeriodDt period = new PeriodDt().setStart(new DateTimeDt("2023-05-01T00:00:00Z"));

    String result = Dstu2CdaFhirUtilities.getStringForIDataType(period);
    assertNotNull(result);
    assertEquals("Mon May 01 00:00:00 UTC 2023", result);
  }

  @Test
  public void testGetMatchingCodeFromCodeableConceptForCodeSystem_CodeableConceptNull() {

    List<String> matchedCodes = new ArrayList<>();
    CodeableConceptDt cd = null;
    String csUrl = "http://example.com";
    String result =
        Dstu2CdaFhirUtilities.getMatchingCodeFromCodeableConceptForCodeSystem(
            matchedCodes, cd, csUrl);
    assertEquals("", result);
  }

  @Test
  public void testGetMatchingCodeFromCodeableConceptForCodeSystem_MatchingCode() {

    List<String> matchedCodes = new ArrayList<>();
    matchedCodes.add("26464-2");

    CodeableConceptDt cd = new CodeableConceptDt();
    CodingDt coding1 = new CodingDt();
    coding1.setCode("26464-2");
    coding1.setDisplay("Test Code Display");
    coding1.setSystem("http://loinc.org");
    cd.addCoding(coding1);

    CodingDt coding2 = new CodingDt();
    coding2.setCode("48642-3");
    coding2.setDisplay("Another Code");
    coding2.setSystem("http://loinc.org");
  ...
  @Test
  public void getGenderXml_test_null() {
    Patient patient = new Patient();
    String result = Dstu2CdaFhirUtilities.getGenderXml(null);
    String expected = "<administrativeGenderCode nullFlavor=\"NI\"/>";
    assertEquals(expected.trim(), result.trim());
  }

  @Test
  public void getGenderXml_test_female() {
    Patient patient = new Patient();
    patient.setGender(AdministrativeGenderEnum.FEMALE);
    IValueSetEnumBinder<AdministrativeGenderEnum> binder = getBinder();
    BoundCodeDt<AdministrativeGenderEnum> femaleGender =
        new BoundCodeDt<>(binder, AdministrativeGenderEnum.FEMALE);
    String result = Dstu2CdaFhirUtilities.getGenderXml(femaleGender);
    assertNotNull(result);
    String expectedxml =
        "<administrativeGenderCode code=\"F\" " + "codeSystem=\"2.16.840.1.113883.5.1\"/>";
    assertEquals(expectedxml.trim(), result.trim());
  }

  @Test
  public void getGenderXml_test_male() {
    Patient patient = new Patient();
    patient.setGender(AdministrativeGenderEnum.MALE);
    IValueSetEnumBinder<AdministrativeGenderEnum> binder = getBinder();
    BoundCodeDt<AdministrativeGenderEnum> maleGender =
        new BoundCodeDt<>(binder, AdministrativeGenderEnum.MALE);
    String result = Dstu2CdaFhirUtilities.getGenderXml(maleGender);
  ...
  @Test
  public void getGenderXml_test_otherGender() {
    Patient patient = new Patient();
    patient.setGender(AdministrativeGenderEnum.OTHER);
    IValueSetEnumBinder<AdministrativeGenderEnum> binder = getBinder();
    BoundCodeDt<AdministrativeGenderEnum> nullGender =
        new BoundCodeDt<>(binder, AdministrativeGenderEnum.OTHER);
    String result = Dstu2CdaFhirUtilities.getGenderXml(nullGender);
    String expectedXml =
  ...
  private IValueSetEnumBinder<AdministrativeGenderEnum> getBinder() {
    return new IValueSetEnumBinder<AdministrativeGenderEnum>() {
      @Override
      public AdministrativeGenderEnum fromCodeString(String s) {
        return AdministrativeGenderEnum.forCode(s);
      }

      @Override
      public String toCodeString(AdministrativeGenderEnum administrativeGenderEnum) {
        return administrativeGenderEnum.getCode();
      }

      @Override
      public String toSystemString(AdministrativeGenderEnum administrativeGenderEnum) {
        return administrativeGenderEnum.getSystem();
      }

      @Override
      public AdministrativeGenderEnum fromCodeString(String s, String s1) {
        return AdministrativeGenderEnum.forCode(s);
      }
    };
  }
