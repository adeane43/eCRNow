...
public class RuleFiltersERSDFhirPathOnlyTest extends BaseKarsTest {
  protected FhirContext fhirContext = FhirContext.forCached(FhirVersionEnum.R4);

  public RuleFiltersERSDFhirPathOnlyTest(TestCaseInfo testCaseInfo) {
    super(testCaseInfo);
  }
  ...
  // Tests will go STALE! They are date dependant
  @Parameters(name = "{0}")
