...
public class SubscriptionNotificationReceiverImpl implements SubscriptionNotificationReceiver {
    ...
    public List<KarProcessingData> processNotification(
        ...
        String requestId = StringEscapeUtils.escapeJava(request.getHeader(Headers.X_REQUEST_ID()));
        String correlationId = StringEscapeUtils.escapeJava(request.getHeader(Headers.X_REQUEST_ID()));

        return processNotification(notificationBundle, requestId, correlationId, launchContext);
    }
    ...
    public List<KarProcessingData> processNotification(
        ...
        NotificationContext nc =
                SubscriptionUtils.getNotificationContext(
                        notificationBundle, requestId, correlationId, false, false, launchContext);
    ...
    public List<KarProcessingData> processRelaunchNotification(
        ...
        return processRelaunchNotification(notificationBundle, requestId, correlationId, launchContext);
    }
    ...
    public List<KarProcessingData> processRelaunchNotification(
        ...
        NotificationContext nc =
                SubscriptionUtils.getNotificationContext(
                        notificationBundle, requestId, correlationId, true, false, launchContext);
    ...
    public List<KarProcessingData> reProcessNotification(
        ...
        return reProcessNotification(notificationBundle, requestId, correlationId, launchContext);
    }
    ...
    public List<KarProcessingData> reProcessNotification(
        ...
        NotificationContext nc =
                SubscriptionUtils.getNotificationContext(
                        notificationBundle, requestId, correlationId, false, true, launchContext);
